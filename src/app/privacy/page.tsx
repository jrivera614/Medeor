...
export default function PrivacyPage() {
  return (
    <div style={{fontFamily:"'DM Sans',system-ui,sans-serif",background:"#0a0a0f",color:"#ccc",minHeight:"100vh",maxWidth:480,margin:"0 auto",padding:"20px 16px 60px"}}>
      ...
      <p style={{fontSize:13,lineHeight:1.8}}>We use Google AdSense to display advertisements. Google may use cookies to serve ads based on your prior visits to this or other websites. You can opt out of personalized advertising by visiting Google Ad Settings at adssettings.google.com. For users in the EEA, UK, and Switzerland, a consent management platform is used to collect consent before personalized ads are shown.</p>
      ...
      <p style={{fontSize:13,lineHeight:1.8}}>We use your browser's local storage to save your quiz progress, checklist states, cookie consent preference, and email signup dismissal. This data stays on your device and is never sent to our servers.</p>

      <h2 style={{fontSize:15,fontWeight:600,color:"#e8e8ed",marginTop:24}}>Third-Party Services</h2>
      <p style={{fontSize:13,lineHeight:1.8}}>We use Formspree to process contact form and email signup submissions. YouTube videos are linked externally. We do not control the privacy practices of these third-party services.</p>
